...
function loginSMU(username, password, corsPrefix, domain, localAxios) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!hiddenform) {
            ...
            wa = (_p = (_o = hiddenformRedirectSMU === null || hiddenformRedirectSMU === void 0 ? void 0 : hiddenformRedirectSMU.data) === null || _o === void 0 ? void 0 : _o.querySelector('input[name="wa"]')) === null || _p === void 0 ? void 0 : _p.getAttribute('value');
            if (!wa)
                throw new Error('No intermediate wa for SMU');
            wresult = (_r = (_q = hiddenformRedirectSMU === null || hiddenformRedirectSMU === void 0 ? void 0 : hiddenformRedirectSMU.data) === null || _q === void 0 ? void 0 : _q.querySelector('input[name="wresult"]')) === null || _r === void 0 ? void 0 : _r.getAttribute('value');
            if (!wresult)
                throw new Error('No intermediate wresult for SMU');
            wctx = (_t = (_s = hiddenformRedirectSMU === null || hiddenformRedirectSMU === void 0 ? void 0 : hiddenformRedirectSMU.data) === null || _s === void 0 ? void 0 : _s.querySelector('input[name="wctx"]')) === null || _t === void 0 ? void 0 : _t.getAttribute('value');
            if (!wctx)
